...
export default function MasterAI() {
  ...
  return (
    <div className="h-[calc(100vh-100px)] flex flex-col text-slate-200 app-card overflow-hidden">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-3 p-3 sm:p-4 bg-[#080a12] border-b border-[#1a1f2e]">
        <div className="lux-panel lux-panel--pad lux-panel--static">
          ...
          <div className="grid grid-cols-3 gap-2 mt-2 text-sm">
            <div className="bg-[#121520] rounded-lg p-2 border border-[rgba(255,255,255,0.08)]">
