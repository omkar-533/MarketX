...
/**
 * Non-dismissible lock screen for expired/blocked accounts.
 * Step 1: admin-configured link · Step 2: screenshot for approval.
 */
                ...
                <div className="access-gate__step">
                  ...
                  <div>
                    ...
                    <p className="access-gate__step-body">
                      {popup?.message?.trim() ||
                        'Open the link below, then upload a screenshot for the desk to approve.'}
                    </p>
                    {link ? (
                      <a
