...
export const CONDITION_REGISTRY: ConditionDef[] = [
  ...
  {
    id: 'EMA_CROSS',
    name: 'EMA Cross / Stack',
    category: 'INDICATORS',
    description: 'Fast EMA vs slow EMA (e.g. 50 vs 200). Use operator < or >.',
    needsDirection: true,
    needsValue: true,
    valueLabel: 'Fast EMA',
    defaultValue: 50,
  },
  {
    ...
    category: 'INDICATORS',
    description: 'Close above EMA (default 21, or set value).',
    needsValue: true,
    valueLabel: 'EMA period',
    defaultValue: 21,
  },
  {
    id: 'PRICE_BELOW_EMA',
    ...
    category: 'INDICATORS',
    description: 'Close below EMA (default 21, or set value).',
    needsValue: true,
    valueLabel: 'EMA period',
    defaultValue: 21,
  },
